<template>
  ...
  <div class="cut_mian">
    <div
      class="w-full h-[633px] bg-cover bg-center bg-[url('/src/assets/img/summer/summer.png')]"
    ></div>
    <div
      class="bg-slate-200 bg-opacity-50 w-full h-[50px] flex items-center justify-end"
    >
      <img src="../../assets/img/summer/summer1.png" alt="" class="mr-[15%]" />
    </div>
    <div class="incenter flex-col mt-[60px]">
      <img src="../../assets/img/summer/summer2.png" alt="" />
      <img src="../../assets/img/summer/summer3.png" alt="" class="mt-2" />
    </div>
    <div class="incenter mt-[50px] mb-[90px]">
      <img src="../../assets/img/summer/summer4.png" alt="" />
      <img src="../../assets/img/summer/summer5.png" alt="" class="ml-20" />
    </div>
