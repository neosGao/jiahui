<template>
    ...
    <div class="cut_mian">
        <div class="top_img">
            <img src="../../assets/img/product/spice/bg.jpg" class="big_img">
        </div>
        <div class="title_switch">
            ...
            <div class="right">
                <div class="item_box">
                    <div class="item active">Branches</div>
                    <div class="item">Spice potted</div>
                    <div class="item">Combination</div>
                    <div class="item">Spice tree</div>
                </div>
                <div class="nul"></div>
            </div>
        </div>
