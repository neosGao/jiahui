<template>
    ...
    <div class="cut_mian">
        <div class="top_img">
            <img src="../../assets/img/product/trees/bg.jpg" class="big_img">
        </div>
        <div class="title_switch">
            ...
            <div class="right">
                <div class="item_box">
                    <div class="item active">Ficus</div>
                    <div class="item">Palm tree</div>
                    <div class="item">Bamboo</div>
                    <div class="item">Banana</div>
                    <div class="item">Monstera</div>
                    <div class="item">Fruit tree</div>
                    <div class="item">Rubber tree</div>
                    <div class="item">Chrysalidocarpus lutescens</div>
