<template>
    ...
    <div class="cut_mian">
        <div class="top_img">
            <img src="../../assets/img/product/potted/bg.jpg" class="big_img">
        </div>
        <div class="title_switch">
            ...
            <div class="right">
                <div class="item_box">
                    <div class="item active">Potted greenery</div>
                    <div class="item">Potted flower</div>
                    <div class="item">Combination potted</div>
                    <div class="item">Chinese bonsai</div>
                    <div class="item">Topiary</div>
                    <div class="item">Desert plants</div>
                </div>
                <div class="nul"></div>
            </div>
        </div>
        <div class="select_box">
            <div class="left">
                <a-select v-model="price" placeholder="Price Group">
                    <a-select-option v-for="item in priceList" :value="item.value">{{ item.label }}</a-select-option>
                </a-select>
            ...
            <div class="right">
                <div class="total"><span>{{ total }}</span>Products Found</div>
        ...
        <div class="content_box">
            <div class="item" v-for="(item, index) in datalist" :key="index">
                <div class="img_box">
                    <img src="../../assets/img/product/potted/potted.png">
                    <div class="like">
